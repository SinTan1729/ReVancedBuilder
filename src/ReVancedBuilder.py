...
from utils.APKPure_dl import get_apks
from utils.Cleanup import err_exit, move_apps, send_notif
from utils.JAVABuilder import build_apps


def update_signatures(appstate) -> None:
    try:
...
def update_tools(appstate) -> dict:
    tools = {}
